...
class LogDetailHeader extends StatelessWidget {
  ...
  const LogDetailHeader({super.key, required this.log, required this.onCopyAll, this.onClose});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(icon: const Icon(Icons.copy), onPressed: onCopyAll, tooltip: 'Copy all details'),
