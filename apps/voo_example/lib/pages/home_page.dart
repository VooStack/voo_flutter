      ...
      body: ListView(
        ...
        children: [
          ...
          _buildFeatureCard(
            ...
            title: 'Logging',
            description:
                'Demonstrates logging with different levels, filtering, and DevTools integration',
          ...
          _buildFeatureCard(
            ...
            title: 'Analytics',
            description:
                'Shows touch tracking, heat maps, and user interaction analytics',
          ...
          _buildFeatureCard(
            ...
            title: 'Performance',
            description:
                'Monitors app performance, frame rendering, and memory usage',
            icon: Icons.speed,
            color: Colors.orange,
            onTap: () => Navigator.push(
              context,
          ...
          _buildFeatureCard(
            ...
            description:
                'Demonstrates Dio interceptors for logging and performance monitoring',
