...
class Counter {
  ...
  Counter({required this.name, this.description, this.unit, required this.meter});
  ...
  void add(int value, {Map<String, dynamic>? attributes}) {
    ...
    final metric = CounterMetric(name: name, value: _value, description: description, unit: unit, attributes: attributes);
...
class UpDownCounter {
  ...
  UpDownCounter({required this.name, this.description, this.unit, required this.meter});

  /// Add to the counter (can be negative)
  void add(int value, {Map<String, dynamic>? attributes}) {
    _value += value;

    final metric = CounterMetric(name: name, value: _value, isMonotonic: false, description: description, unit: unit, attributes: attributes);
...
class Histogram {
  ...
  Histogram({required this.name, this.description, this.unit, this.explicitBounds, required this.meter});
...
class Gauge {
  ...
  Gauge({required this.name, this.description, this.unit, required this.meter});

  /// Set the gauge value
  void set(double value, {Map<String, dynamic>? attributes}) {
    _value = value;

    final metric = GaugeMetric(name: name, value: _value, description: description, unit: unit, attributes: attributes);
