...
class HeatMapData extends Equatable {
  ...
  factory HeatMapData.fromMap(Map<String, dynamic> map) {
    return HeatMapData(
      ...
      screenSize: Size((map['screen_width'] as num).toDouble(), (map['screen_height'] as num).toDouble()),
...
class HeatMapPoint extends Equatable {
  ...
  Map<String, dynamic> toMap() {
    return {'x': position.dx, 'y': position.dy, 'intensity': intensity, 'count': count, 'primary_type': primaryType.name};
  }
