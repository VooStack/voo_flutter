  ...
  group('OData GUID Handling Tests', () {
    ...
    group('GUID string formatting', () {
      test('should format GUID strings without quotes', () {
        ...
        final filters = {'userId': const VooDataFilter(operator: VooFilterOperator.equals, value: guid)};
      ...
      test('should handle uppercase GUID', () {
        ...
        final filters = {'roleId': const VooDataFilter(operator: VooFilterOperator.equals, value: guid)};
      ...
      test('should handle mixed case GUID', () {
        ...
        final filters = {'id': const VooDataFilter(operator: VooFilterOperator.equals, value: guid)};
    ...
    group('GUID in different operators', () {
      ...
      test('should handle GUID with notEquals operator', () {
        final filters = {'excludeId': const VooDataFilter(operator: VooFilterOperator.notEquals, value: guid)};
      ...
      test('should handle GUID with contains operator', () {
        final filters = {'relatedId': const VooDataFilter(operator: VooFilterOperator.contains, value: guid)};
    ...
    group('Multiple GUIDs in filters', () {
      test('should handle multiple GUIDs in inList operator', () {
        ...
        final filters = {
          'userId': const VooDataFilter(operator: VooFilterOperator.inList, value: [guid1, guid2, guid3]),
        };
      ...
      test('should handle GUIDs in collection navigation property', () {
        ...
        final filters = {
          'roles': const VooDataFilter(operator: VooFilterOperator.inList, value: [roleId1, roleId2], odataCollectionProperty: 'Id'),
        };
      ...
      test('should handle single GUID in collection navigation property', () {
        ...
        final filters = {'roles': const VooDataFilter(operator: VooFilterOperator.contains, value: roleId, odataCollectionProperty: 'Id')};
    ...
    group('GUID vs regular string differentiation', () {
      test('should quote regular strings that look similar to GUIDs', () {
        ...
        final filters = {'code': const VooDataFilter(operator: VooFilterOperator.equals, value: invalidGuid)};
      ...
      test('should quote strings with GUID-like format but invalid characters', () {
        ...
        final filters = {'token': const VooDataFilter(operator: VooFilterOperator.equals, value: notGuid)};
      ...
      test('should not confuse dates with GUIDs', () {
        ...
        final filters = {'createdAt': const VooDataFilter(operator: VooFilterOperator.equals, value: dateString)};
    ...
    group('Edge cases', () {
      test('should handle nil UUID (all zeros)', () {
        ...
        final filters = {'emptyId': const VooDataFilter(operator: VooFilterOperator.equals, value: nilGuid)};
      ...
      test('should handle GUID with all F characters', () {
        ...
        final filters = {'maxId': const VooDataFilter(operator: VooFilterOperator.equals, value: maxGuid)};
      ...
      test('should handle GUID without hyphens as regular string', () {
        ...
        final filters = {'id': const VooDataFilter(operator: VooFilterOperator.equals, value: guidWithoutHyphens)};
    ...
    group('Integration with other filter types', () {
      test('should handle mix of GUID, string, and date filters', () {
        ...
        final createdAt = DateTime.utc(2024, 1, 15, 10);

        final filters = {
          'userId': const VooDataFilter(operator: VooFilterOperator.equals, value: guid),
          'userName': const VooDataFilter(operator: VooFilterOperator.equals, value: userName),
          'createdAt': VooDataFilter(operator: VooFilterOperator.greaterThan, value: createdAt),
        };
