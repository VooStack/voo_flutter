  ...
  group('VooDataGridResponse', () {
    group('constructor', () {
      test('should create instance with Map data', () {
        ...
        // Act
        final response = VooDataGridResponse<Map<String, dynamic>>(rows: rows, totalRows: totalRows, page: page, pageSize: pageSize);
      ...
      test('should create instance with typed data', () {
        // Arrange
        final rows = [TestData(id: 1, name: 'Item 1'), TestData(id: 2, name: 'Item 2')];

        // Act
        final response = VooDataGridResponse<TestData>(rows: rows, totalRows: 50, page: 0, pageSize: 20);
      ...
      test('should create instance with empty rows', () {
        // Arrange & Act
        const response = VooDataGridResponse<Map<String, dynamic>>(rows: [], totalRows: 0, page: 1, pageSize: 10);
      ...
      test('should handle large datasets', () {
        ...
        // Act
        final response = VooDataGridResponse<Map<String, dynamic>>(rows: rows, totalRows: 10000, page: 5, pageSize: 1000);
    ...
    group('different generic types', () {
      test('should work with List type', () {
        ...
        // Act
        final response = VooDataGridResponse<List>(rows: rows, totalRows: 2, page: 0, pageSize: 10);
      ...
      test('should work with String type', () {
        ...
        // Act
        final response = VooDataGridResponse<String>(rows: rows, totalRows: 3, page: 0, pageSize: 10);
      ...
      test('should work with dynamic type', () {
        ...
        // Act
        final response = VooDataGridResponse<dynamic>(rows: rows, totalRows: 4, page: 0, pageSize: 10);
    ...
    group('pagination scenarios', () {
      test('should handle first page', () {
        // Arrange & Act
        final response = VooDataGridResponse<Map<String, dynamic>>(rows: List.generate(10, (i) => {'id': i}), totalRows: 100, page: 0, pageSize: 10);
      ...
      test('should handle middle page', () {
        // Arrange & Act
        final response = VooDataGridResponse<Map<String, dynamic>>(rows: List.generate(10, (i) => {'id': i + 50}), totalRows: 100, page: 5, pageSize: 10);
      ...
      test('should handle last page with partial results', () {
        // Arrange & Act
        final response = VooDataGridResponse<Map<String, dynamic>>(rows: List.generate(5, (i) => {'id': i + 95}), totalRows: 95, page: 9, pageSize: 10);
      ...
      test('should handle single page of results', () {
        // Arrange & Act
        final response = VooDataGridResponse<Map<String, dynamic>>(rows: List.generate(3, (i) => {'id': i}), totalRows: 3, page: 0, pageSize: 10);
...
class TestData {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TestData && runtimeType == other.runtimeType && id == other.id && name == other.name;
