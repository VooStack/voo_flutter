  ...
  group('VooDataFilter', () {
    group('constructor', () {
      test('should create instance with required parameters', () {
        // Arrange & Act
        const filter = VooDataFilter(operator: VooFilterOperator.equals, value: 'test');
    ...
    group('different operator types', () {
      test('should create contains filter', () {
        // Arrange & Act
        const filter = VooDataFilter(operator: VooFilterOperator.contains, value: 'search term');
      ...
      test('should create greaterThan filter', () {
        // Arrange & Act
        const filter = VooDataFilter(operator: VooFilterOperator.greaterThan, value: 50);
      ...
      test('should create lessThan filter', () {
        // Arrange & Act
        const filter = VooDataFilter(operator: VooFilterOperator.lessThan, value: 100);
      ...
      test('should create startsWith filter', () {
        // Arrange & Act
        const filter = VooDataFilter(operator: VooFilterOperator.startsWith, value: 'prefix');
      ...
      test('should create endsWith filter', () {
        // Arrange & Act
        const filter = VooDataFilter(operator: VooFilterOperator.endsWith, value: 'suffix');
    ...
    group('range operations', () {
      test('should create between filter with valueTo', () {
        // Arrange & Act
        final filter = VooDataFilter(operator: VooFilterOperator.between, value: DateTime(2024), valueTo: DateTime(2024, 12, 31));
      ...
      test('should create numeric between filter', () {
        // Arrange & Act
        const filter = VooDataFilter(operator: VooFilterOperator.between, value: 0.0, valueTo: 99.99);
    ...
    group('null checks', () {
      ...
      test('should create isNotNull filter', () {
        // Arrange & Act
        const filter = VooDataFilter(operator: VooFilterOperator.isNotNull, value: null);
