  ...
  group('VooDataGridState', () {
    group('loading state', () {
      ...
      test('should set isLoading to true', () {
        // Arrange & Act
        const state = VooDataGridState<Map<String, dynamic>>(isLoading: true);
    ...
    group('error handling', () {
      ...
      test('should set error message', () {
        // Arrange & Act
        const state = VooDataGridState<Map<String, dynamic>>(error: 'Something went wrong');
      ...
      test('should clear error via copyWith', () {
        // Arrange
        const initialState = VooDataGridState<Map<String, dynamic>>(error: 'Previous error');
    ...
    group('pagination', () {
      test('should calculate totalPages correctly', () {
        // Arrange & Act
        const state = VooDataGridState<Map<String, dynamic>>(totalRows: 100);
      ...
      test('should handle zero pageSize', () {
        // Arrange & Act
        const state = VooDataGridState<Map<String, dynamic>>(totalRows: 100, pageSize: 0);
      ...
      test('should round up for partial pages', () {
        // Arrange & Act
        const state = VooDataGridState<Map<String, dynamic>>(totalRows: 95);
    ...
    group('selection', () {
      ...
      test('should update selectedRows via copyWith', () {
        ...
        // Act
        final updatedState = initialState.copyWith(selectedRows: selectedRows);
    ...
    group('filters', () {
      ...
      test('should update filters via copyWith', () {
        // Arrange
        const initialState = VooDataGridState<Map<String, dynamic>>();
        final filters = {'name': const VooDataFilter(operator: VooFilterOperator.contains, value: 'test')};
    ...
    group('sorts', () {
      ...
      test('should update sorts via copyWith', () {
        // Arrange
        const initialState = VooDataGridState<Map<String, dynamic>>();
        const sorts = [VooColumnSort(field: 'name', direction: VooSortDirection.ascending)];
    ...
    group('mode', () {
      ...
      test('should support local mode', () {
        // Arrange & Act
        const state = VooDataGridState<Map<String, dynamic>>(mode: VooDataGridMode.local);
      ...
      test('should support mixed mode', () {
        // Arrange & Act
        const state = VooDataGridState<Map<String, dynamic>>(mode: VooDataGridMode.mixed);
    ...
    group('data', () {
      ...
      test('should set rows', () {
        ...
        // Act
        final state = VooDataGridState<Map<String, dynamic>>(rows: rows);
      ...
      test('should set allRows for local mode', () {
        ...
        // Act
        final state = VooDataGridState<Map<String, dynamic>>(mode: VooDataGridMode.local, allRows: allRows);
