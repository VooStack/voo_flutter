...
void main() {
  group('SortIndicator', () {
    testWidgets('should display upward arrow for ascending direction', (tester) async {
      // Arrange & Act
      await tester.pumpWidget(makeTestableWidget(child: const SortIndicator(direction: VooSortDirection.ascending)));
    ...
    testWidgets('should display downward arrow for descending direction', (tester) async {
      // Arrange & Act
      await tester.pumpWidget(makeTestableWidget(child: const SortIndicator(direction: VooSortDirection.descending)));
    ...
    testWidgets('should display unfold_more icon for none direction', (tester) async {
      // Arrange & Act
      await tester.pumpWidget(makeTestableWidget(child: const SortIndicator(direction: VooSortDirection.none)));
    ...
    testWidgets('should use custom active color for ascending', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: const SortIndicator(direction: VooSortDirection.ascending, activeColor: customColor),
        ),
      );
    ...
    testWidgets('should use custom active color for descending', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: const SortIndicator(direction: VooSortDirection.descending, activeColor: customColor),
        ),
      );
    ...
    testWidgets('should use custom inactive color for none direction', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: const SortIndicator(direction: VooSortDirection.none, inactiveColor: customColor),
        ),
      );
    ...
    testWidgets('should use theme primary color by default for ascending', (tester) async {
      // Arrange
      final theme = ThemeData(colorScheme: const ColorScheme.light(primary: Colors.blue));

      // Act
      await tester.pumpWidget(
        makeTestableWidget(
          theme: theme,
          child: const SortIndicator(direction: VooSortDirection.ascending),
        ),
      );
    ...
    testWidgets('should use custom icon size', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: const SortIndicator(direction: VooSortDirection.ascending, iconSize: customSize),
        ),
      );
    ...
    testWidgets('should render correctly in different themes', (tester) async {
      ...
      final darkTheme = ThemeData.dark().copyWith(colorScheme: const ColorScheme.dark(primary: Colors.tealAccent));

      await tester.pumpWidget(
        makeTestableWidget(
          theme: darkTheme,
          child: const SortIndicator(direction: VooSortDirection.descending),
        ),
      );
