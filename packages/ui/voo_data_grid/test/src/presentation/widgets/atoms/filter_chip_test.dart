...
void main() {
  group('VooFilterChip', () {
    testWidgets('should display label only when value is null', (tester) async {
      // Arrange & Act
      await tester.pumpWidget(makeTestableWidget(child: const VooFilterChip(label: 'Status')));
    ...
    testWidgets('should display label and value when value is provided', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: const VooFilterChip(label: 'Status', value: 'Active'),
        ),
      );
    ...
    testWidgets('should show delete icon when onDeleted is provided', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: VooFilterChip(label: 'Category', value: 'Electronics', onDeleted: () {}),
        ),
      );
    ...
    testWidgets('should not show delete icon when onDeleted is null', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: const VooFilterChip(label: 'Category', value: 'Electronics'),
        ),
      );
    ...
    testWidgets('should call onDeleted callback when delete icon is tapped', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: VooFilterChip(label: 'Price', value: '> 100', onDeleted: () => wasDeleted = true),
        ),
      );
    ...
    testWidgets('should use custom label style', (tester) async {
      // Arrange
      const customStyle = TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.blue);

      // Act
      await tester.pumpWidget(
        makeTestableWidget(
          child: const VooFilterChip(label: 'Custom', labelStyle: customStyle),
        ),
      );
    ...
    testWidgets('should use default label style with fontSize 12', (tester) async {
      // Act
      await tester.pumpWidget(makeTestableWidget(child: const VooFilterChip(label: 'Default')));
    ...
    testWidgets('should use custom delete icon size', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: VooFilterChip(label: 'Test', onDeleted: () {}, deleteIconSize: customSize),
        ),
      );
    ...
    testWidgets('should use default delete icon size of 16', (tester) async {
      ...
      await tester.pumpWidget(
        makeTestableWidget(
          child: VooFilterChip(label: 'Test', onDeleted: () {}),
        ),
      );
    ...
    testWidgets('should render InputChip with compact visual density', (tester) async {
      // Act
      await tester.pumpWidget(makeTestableWidget(child: const VooFilterChip(label: 'Compact')));
    ...
    group('edge cases', () {
      testWidgets('should handle empty label', (tester) async {
        // Act
        await tester.pumpWidget(makeTestableWidget(child: const VooFilterChip(label: '')));
      ...
      testWidgets('should handle empty value', (tester) async {
        ...
        await tester.pumpWidget(
          makeTestableWidget(
            child: const VooFilterChip(label: 'Field', value: ''),
          ),
        );
      ...
      testWidgets('should handle very long label and value', (tester) async {
        ...
        await tester.pumpWidget(
          makeTestableWidget(
            child: const VooFilterChip(label: longLabel, value: longValue),
          ),
        );
    ...
    group('accessibility', () {
      testWidgets('should be findable by type', (tester) async {
        // Act
        await tester.pumpWidget(makeTestableWidget(child: const VooFilterChip(label: 'Test')));
