  ...
  group('VooDataGridResponse', () {
    group('constructor', () {
      test('should create instance with required parameters', () {
        ...
        // Act
        final response = VooDataGridResponse(rows: rows, totalRows: totalRows, page: page, pageSize: pageSize);
      ...
      test('should create instance with empty rows', () {
        // Arrange & Act
        const response = VooDataGridResponse(rows: [], totalRows: 0, page: 1, pageSize: 10);
      ...
      test('should handle large datasets', () {
        ...
        // Act
        final response = VooDataGridResponse(rows: rows, totalRows: 10000, page: 5, pageSize: 1000);
    ...
    group('totalPages', () {
      test('should calculate total pages correctly', () {
        // Arrange & Act
        const response = VooDataGridResponse(rows: [], totalRows: 95, page: 1, pageSize: 10);
      ...
      test('should handle exact page boundaries', () {
        // Arrange & Act
        const response = VooDataGridResponse(rows: [], totalRows: 100, page: 1, pageSize: 10);
    ...
    group('hasNextPage', () {
      test('should return true when more pages exist', () {
        // Arrange & Act
        const response = VooDataGridResponse(rows: [], totalRows: 100, page: 5, pageSize: 10);
      ...
      test('should return false on last page', () {
        // Arrange & Act
        const response = VooDataGridResponse(rows: [], totalRows: 100, page: 10, pageSize: 10);
    ...
    group('hasPreviousPage', () {
      ...
      test('should return false when page is 0', () {
        // Arrange & Act
        const response = VooDataGridResponse(rows: [], totalRows: 100, page: 0, pageSize: 10);
    ...
    group('copyWith', () {
      ...
      test('should create copy with updated totalRows', () {
        // Arrange
        const original = VooDataGridResponse(rows: [], totalRows: 10, page: 1, pageSize: 10);
