  ...
  group('VooColumnSort', () {
    group('constructor', () {
      test('should create instance with ascending direction', () {
        // Arrange & Act
        const sort = VooColumnSort(field: 'name', direction: VooSortDirection.ascending);
      ...
      test('should create instance with descending direction', () {
        // Arrange & Act
        const sort = VooColumnSort(field: 'price', direction: VooSortDirection.descending);
      ...
      test('should create instance with none direction', () {
        // Arrange & Act
        const sort = VooColumnSort(field: 'status', direction: VooSortDirection.none);
    ...
    group('direction states', () {
      test('should support all sort directions', () {
        ...
        const directions = [VooSortDirection.ascending, VooSortDirection.descending, VooSortDirection.none];

        for (final direction in directions) {
          final sort = VooColumnSort(field: 'testField', direction: direction);
    ...
    group('multiple column sorting scenarios', () {
      ...
      test('should handle clearing sorts with none direction', () {
        // Arrange
        const clearedSort = VooColumnSort(field: 'name', direction: VooSortDirection.none);
