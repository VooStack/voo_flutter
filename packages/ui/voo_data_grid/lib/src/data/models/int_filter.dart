...
class IntFilter extends BaseFilter {
  const IntFilter({required super.fieldName, required int super.value, required super.operator, super.secondaryFilter});

  factory IntFilter.fromJson(Map<String, dynamic> json) => IntFilter(
    fieldName: json['fieldName'] as String,
    value: json['value'] is int ? json['value'] as int : int.parse(json['value'].toString()),
