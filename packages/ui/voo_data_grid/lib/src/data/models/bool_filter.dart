...
class BoolFilter extends BaseFilter {
  const BoolFilter({required super.fieldName, required bool super.value, super.operator = 'Equals', super.secondaryFilter});

  factory BoolFilter.fromJson(Map<String, dynamic> json) => BoolFilter(
    fieldName: json['fieldName'] as String,
    value: json['value'] is bool ? json['value'] as bool : json['value'].toString().toLowerCase() == 'true',
