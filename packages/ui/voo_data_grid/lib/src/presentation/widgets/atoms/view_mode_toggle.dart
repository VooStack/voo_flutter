...
class ViewModeToggle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return IconButton(
      icon: Icon(isTableMode ? Icons.view_agenda : Icons.table_chart),
      onPressed: onModeChanged != null ? () => onModeChanged!(isTableMode ? VooDataGridDisplayMode.cards : VooDataGridDisplayMode.table) : null,
