...
class VooBreakpoint {
  ...
  static const compact = VooBreakpoint(
    minWidth: 0,
    maxWidth: VooBreakpoints.compact,
  ...
  static const medium = VooBreakpoint(
    minWidth: VooBreakpoints.compact,
    maxWidth: VooBreakpoints.expanded,
  ...
  static const expanded = VooBreakpoint(
    minWidth: VooBreakpoints.expanded,
    maxWidth: VooBreakpoints.xl,
