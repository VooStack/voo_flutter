...
import 'package:voo_forms/src/presentation/config/utils/formatters/improved_currency_formatter.dart';

void main() {
  group('ImprovedCurrencyFormatter', () {
    group('Incremental typing', () {
      test('typing digits incrementally formats correctly', () {
        final formatter = ImprovedCurrencyFormatter.usd();
    ...
    group('Currency variants', () {
      test('EUR formatter works correctly', () {
        final formatter = ImprovedCurrencyFormatter.eur();
      ...
      test('GBP formatter works correctly', () {
        final formatter = ImprovedCurrencyFormatter.gbp();
      ...
      test('JPY formatter works correctly (no decimals)', () {
        final formatter = ImprovedCurrencyFormatter.jpy();
    ...
    group('Parsing', () {
      test('parses formatted USD correctly', () {
        expect(ImprovedCurrencyFormatter.parse('\$1,234.56'), 1234.56);
        expect(ImprovedCurrencyFormatter.parse('\$0.99'), 0.99);
        expect(ImprovedCurrencyFormatter.parse('\$10'), 10.0);
      });
      ...
      test('handles empty and invalid input', () {
        expect(ImprovedCurrencyFormatter.parse(''), null);
        expect(ImprovedCurrencyFormatter.parse('abc'), null);
      });
    });
