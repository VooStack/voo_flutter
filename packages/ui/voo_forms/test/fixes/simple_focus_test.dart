...
void main() {
  testWidgets('field maintains focus when typing with validation error present', (tester) async {
      ...
      MaterialApp(
        home: Scaffold(
          body: VooFormScope(
            ...
            isReadOnly: false,
            isLoading: false,
            child: VooTextField(name: 'test', label: 'Test Field', focusNode: focusNode, validators: const [RequiredValidation<String>()]),
          ),
        ),
      ),
    );
    ...
    controller.registerField('test', validators: [const RequiredValidation<String>()]);
