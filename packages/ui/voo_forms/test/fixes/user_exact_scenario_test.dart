                      ...
                      form: VooForm(
                        ...
                        fields: [
                          VooTextField(
                            name: 'first_name',
                            label: 'First Name',
                            initialValue: state.isEditMode ? state.userForm['firstName'] as String? : state.userDetails['firstName'] as String?,
                          ),
                          VooTextField(
                            name: 'last_name',
                            label: 'Last Name',
                            initialValue: state.isEditMode ? state.userForm['lastName'] as String? : state.userDetails['lastName'] as String?,
                          ),
                          VooTextField(
                            name: 'email',
                            label: 'Email',
                            initialValue: state.isEditMode ? state.userForm['email'] as String? : state.userDetails['email'] as String?,
                          ),
                          VooPhoneField(
                            name: 'phone_number',
                            label: 'Phone Number',
                            initialValue: state.isEditMode ? state.userForm['phoneNumber'] as String? : state.userDetails['phoneNumber'] as String?,
                          ),
                          VooCheckboxField(
                            name: 'is_active',
                            label: 'Active',
                            initialValue: state.isEditMode ? state.userForm['isActive'] as bool? : state.userDetails['isActive'] as bool?,
                          ),
                        ],
                      ),
                    ),
