              ...
              form: VooForm(
                ...
                fields: [
                  ...
                  VooTextField(
                    ...
                    initialValue: state.isEditMode 
                      ? state.userForm.middleInitial 
                      : state.userDetails.middleInitial,
                    maxLength: 1,
                  ),
                  VooTextField(
                    name: 'last_name',
                  ...
                  VooDropdownField<String>(
                    ...
                    initialValue: state.isEditMode 
                      ? state.userForm.permissionLevel 
                      : state.userDetails.permissionLevel,
                  ),
                  ...
                  VooCheckboxField(
                    ...
                    initialValue: state.isEditMode 
                      ? state.userForm.isAnalystOrResearcher 
                      : state.userDetails.isAnalystOrResearcher,
                  ),
                  VooCheckboxField(
                    name: 'is_active',
                    label: 'Active',
                    initialValue: state.isEditMode 
                      ? state.userForm.isActive 
                      : state.userDetails.isActive,
                  ),
                ],
              ),
            ),
...
void main() {
  group('User Scenario - Initial Values Display Without Readonly Toggle', () {
    testWidgets('EXACT USER SCENARIO: Form displays initial values after async load WITHOUT readonly toggle', 
      (tester) async {
      ...
      expect(find.text('Manager, Reviewer'), findsOneWidget, 
    ...
    testWidgets('Form with controller outside BlocBuilder maintains values across rebuilds', 
      (tester) async {
      // Set a larger test viewport to avoid RenderFlex overflow
      tester.view.physicalSize = const Size(1400, 900);
      tester.view.devicePixelRatio = 1.0;
    ...
    testWidgets('All field types display initial values immediately without readonly', 
      (tester) async {
    ...
    testWidgets('VooFormPageBuilder with external controller displays initial values', 
      (tester) async {
      // Set a larger test viewport to avoid RenderFlex overflow
      tester.view.physicalSize = const Size(1400, 900);
      tester.view.devicePixelRatio = 1.0;
