...
class VooFormErrorConfig {
  ...
  static const VooFormErrorConfig immediate = VooFormErrorConfig(
    displayMode: VooFormErrorDisplay.onType,
  );
  
  static const VooFormErrorConfig delayed = VooFormErrorConfig(
    displayMode: VooFormErrorDisplay.onTypeDebounced,
  );
  
  static const VooFormErrorConfig gentle = VooFormErrorConfig(
    showErrorIcon: false,
  );
  
  static const VooFormErrorConfig strict = VooFormErrorConfig(
    displayMode: VooFormErrorDisplay.always,
    shakeOnError: true,
  );
  
  static const VooFormErrorConfig submitOnly = VooFormErrorConfig(
    displayMode: VooFormErrorDisplay.onSubmit,
  );
}