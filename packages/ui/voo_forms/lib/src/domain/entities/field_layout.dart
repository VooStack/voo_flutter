...
class VooFieldLayout {
  ...
  static const VooFieldLayout fullWidthField = VooFieldLayout(
    fullWidth: true,
    newRow: true,
  );
  
  /// Layout for compact fields (like checkboxes)
  static const VooFieldLayout compact = VooFieldLayout(
    minWidth: 150,
    maxWidth: 250,
  );
  
  /// Layout for wide fields (like text areas, list fields)
  static const VooFieldLayout wide = VooFieldLayout(
    fullWidth: true,
    newRow: true,
    minWidth: 400,
  );
