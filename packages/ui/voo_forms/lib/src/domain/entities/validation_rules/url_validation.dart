...
class UrlValidation extends VooValidationRule<String> {
  static final RegExp _urlRegExp = RegExp(r'^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&\/=]*)$');

  const UrlValidation({super.errorMessage = 'Please enter a valid URL'});
