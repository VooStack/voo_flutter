                ...
                if (label != null)
                  Padding(
                    ...
                    child: Text(
                      label!,
                      style:
                          labelStyle ?? theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w500, letterSpacing: 0.5, color: theme.colorScheme.primary),
                    ),
                  ),
                if (subtitle != null) ...[
...
extension VooFormSectionDividerStyles on VooFormSectionDivider {
  ...
  static VooFormSectionDivider spacer({Key? key, String name = 'spacer', double height = 24.0, VooFieldLayout layout = VooFieldLayout.wide}) =>
      VooFormSectionDivider(key: key, name: name, showLine: false, topSpacing: height / 2, bottomSpacing: height / 2, layout: layout);
}
