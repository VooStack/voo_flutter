...
class _VooSliderFieldWidgetState extends State<VooSliderFieldWidget> {
  ...
  void initState() {
    super.initState();
    _value = (widget.field.value as num?)?.toDouble() ?? widget.field.min?.toDouble() ?? 0.0;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        if (widget.field.label != null && widget.options.labelPosition != LabelPosition.hidden)
          Padding(
        ...
        SliderTheme(
          ...
          child: Slider(
            ...
            onChanged: widget.field.enabled
                ? (value) {
                    setState(() {
                      _value = value;
                    });
