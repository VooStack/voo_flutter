...
class StrictNumberFormatter extends TextInputFormatter {
  ...
  StrictNumberFormatter({this.allowDecimals = true, this.allowNegative = true, this.maxDecimalPlaces, this.minValue, this.maxValue});
  ...
  TextEditingValue formatEditUpdate(TextEditingValue oldValue, TextEditingValue newValue) {
    ...
    if (newValue.text != '-' && !newValue.text.endsWith('.') && newValue.text != '-.') {
...
class StrictIntegerFormatter extends StrictNumberFormatter {
  StrictIntegerFormatter({super.allowNegative, int? super.minValue, int? super.maxValue}) : super(allowDecimals: false);
}

/// Positive number formatter
class PositiveNumberFormatter extends StrictNumberFormatter {
  PositiveNumberFormatter({super.allowDecimals, super.maxDecimalPlaces, super.maxValue}) : super(allowNegative: false, minValue: 0);
}

/// Strict currency formatter
class StrictCurrencyFormatter extends StrictNumberFormatter {
  StrictCurrencyFormatter({super.maxValue}) : super(allowDecimals: true, allowNegative: false, maxDecimalPlaces: 2, minValue: 0);
}

/// Strict percentage formatter (0-100)
class StrictPercentageFormatter extends StrictNumberFormatter {
  StrictPercentageFormatter({super.allowDecimals}) : super(allowNegative: false, maxDecimalPlaces: allowDecimals ? 2 : null, minValue: 0, maxValue: 100);
}
