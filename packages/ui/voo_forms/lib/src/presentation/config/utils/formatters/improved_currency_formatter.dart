...
/// Improved currency formatter that properly handles incremental typing
/// 
...
class ImprovedCurrencyFormatter extends TextInputFormatter {
  ...
  /// Creates an improved currency formatter with the specified options
  ImprovedCurrencyFormatter({
    this.symbol = '\$',
  ...
  factory ImprovedCurrencyFormatter.usd() => ImprovedCurrencyFormatter();
      
  factory ImprovedCurrencyFormatter.eur() => ImprovedCurrencyFormatter(
        symbol: '€',
        locale: 'de_DE',
        symbolBeforeAmount: false,
      );
      
  factory ImprovedCurrencyFormatter.gbp() => ImprovedCurrencyFormatter(
        symbol: '£',
        locale: 'en_GB',
      );
      
  factory ImprovedCurrencyFormatter.jpy() => ImprovedCurrencyFormatter(
        symbol: '¥',
        decimalDigits: 0,
        locale: 'ja_JP',
      );
