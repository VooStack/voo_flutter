...
class CurrencyFormatter extends TextInputFormatter {
  ...
  factory CurrencyFormatter.eur() => CurrencyFormatter(symbol: '€', locale: 'de_DE', symbolBeforeAmount: false);

  factory CurrencyFormatter.gbp() => CurrencyFormatter(symbol: '£', locale: 'en_GB');

  factory CurrencyFormatter.jpy() => CurrencyFormatter(symbol: '¥', decimalDigits: 0, locale: 'ja_JP');
