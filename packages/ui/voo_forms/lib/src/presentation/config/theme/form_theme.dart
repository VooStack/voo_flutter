...
class VooFormTheme {
  ...
  static ThemeData generateFormTheme({
    ...
    final content = contentPadding ?? const EdgeInsets.symmetric(horizontal: 20.0, vertical: 18.0);
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        enabledBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(color: colorScheme.outline.withValues(alpha: 0.2), width: 1.5),
        ),
        ...
        errorBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(radius),
          borderSide: BorderSide(color: colorScheme.error.withValues(alpha: 0.6), width: 1.5),
        ),
        ...
        labelStyle: TextStyle(color: colorScheme.onSurfaceVariant, fontSize: 14.0, fontWeight: FontWeight.w500),
        floatingLabelStyle: TextStyle(color: colorScheme.primary, fontSize: 12.0, fontWeight: FontWeight.w600),
        hintStyle: TextStyle(color: colorScheme.onSurfaceVariant.withValues(alpha: 0.5), fontSize: 14.0, fontWeight: FontWeight.w400),
        errorStyle: TextStyle(color: colorScheme.error, fontSize: 12.0, fontWeight: FontWeight.w500),
        helperStyle: TextStyle(color: colorScheme.onSurfaceVariant.withValues(alpha: 0.7), fontSize: 12.0, fontWeight: FontWeight.w400),
        prefixStyle: TextStyle(color: colorScheme.onSurface, fontSize: 14.0),
        suffixStyle: TextStyle(color: colorScheme.onSurface, fontSize: 14.0),
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          textStyle: const TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600, letterSpacing: 0.5),
        ),
      ),
      ...
      textButtonTheme: TextButtonThemeData(
        style: TextButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(radius)),
          textStyle: const TextStyle(fontSize: 14.0, fontWeight: FontWeight.w500, letterSpacing: 0.3),
        ),
      ),
      checkboxTheme: CheckboxThemeData(
        ...
        side: BorderSide(color: colorScheme.outline.withValues(alpha: 0.5), width: 2.0),
      ),
      ...
      sliderTheme: SliderThemeData(
        ...
        valueIndicatorTextStyle: TextStyle(color: colorScheme.onPrimary, fontWeight: FontWeight.w600),
        trackHeight: 6.0,
  ...
  static InputDecoration getFieldDecoration({
    ...
    suffixIcon: suffixIcon != null
        ...
        : isPassword
        ? IconButton(icon: const Icon(Icons.visibility_outlined), onPressed: onSuffixTap)
        : null,
  );
  ...
  static BoxDecoration getFormCardDecoration(BuildContext context) {
    ...
    return BoxDecoration(
      ...
      boxShadow: [BoxShadow(color: theme.colorScheme.shadow.withValues(alpha: 0.1), blurRadius: 10.0, offset: const Offset(0, 4))],
    );
  }
