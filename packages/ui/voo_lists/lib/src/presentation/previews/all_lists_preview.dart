...
class VooListsShowcasePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('VooLists Showcase'), centerTitle: true),
        ...
        slivers: [
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                children: [
                  Icon(Icons.list_alt, size: 64, color: Theme.of(context).colorScheme.primary),
                  const SizedBox(height: 16),
                  Text('VooLists Package', style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  Text('Comprehensive list widgets for Flutter', style: Theme.of(context).textTheme.bodyLarge),
              ...
              delegate: SliverChildBuilderDelegate((context, index) {
                ...
                return Card(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute<void>(builder: (context) => preview));
                    },
                    child: Padding(
                      padding: const EdgeInsets.all(16),
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text('View', style: Theme.of(context).textTheme.labelMedium?.copyWith(color: Theme.of(context).colorScheme.primary)),
