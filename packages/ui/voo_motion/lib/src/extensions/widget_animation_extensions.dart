...
extension VooMotionExtensions on Widget {
  ...
  /// Fade out animation
  Widget fadeOut({Duration? duration, Duration? delay, Curve? curve, double? to, VoidCallback? onComplete}) => VooFadeAnimation(
    config: VooAnimationConfig(
      duration: duration ?? const Duration(milliseconds: 500),
      delay: delay ?? Duration.zero,
  ...
  /// Slide in from left
  Widget slideInLeft({Duration? duration, Duration? delay, Curve? curve, double? offset, VoidCallback? onComplete}) => VooSlideAnimation(
    config: VooAnimationConfig(
      duration: duration ?? const Duration(milliseconds: 500),
      delay: delay ?? Duration.zero,
  ...
  /// Slide in from right
  Widget slideInRight({Duration? duration, Duration? delay, Curve? curve, double? offset, VoidCallback? onComplete}) => VooSlideAnimation(
    config: VooAnimationConfig(
      duration: duration ?? const Duration(milliseconds: 500),
      delay: delay ?? Duration.zero,
      curve: curve ?? Curves.easeOutCubic,
  ...
  /// Slide in from top
  Widget slideInTop({Duration? duration, Duration? delay, Curve? curve, double? offset, VoidCallback? onComplete}) => VooSlideAnimation(
    config: VooAnimationConfig(
      duration: duration ?? const Duration(milliseconds: 500),
      delay: delay ?? Duration.zero,
      curve: curve ?? Curves.easeOutCubic,
  ...
  Widget slideInBottom({Duration? duration, Duration? delay, Curve? curve, double? offset, VoidCallback? onComplete}) => VooSlideAnimation(
    config: VooAnimationConfig(
      duration: duration ?? const Duration(milliseconds: 500),
      delay: delay ?? Duration.zero,
      curve: curve ?? Curves.easeOutCubic,
  ...
  /// Scale in animation
  Widget scaleIn({Duration? duration, Duration? delay, Curve? curve, double? from, double? to, VoidCallback? onComplete}) => VooScaleAnimation(
    config: VooAnimationConfig(
      duration: duration ?? const Duration(milliseconds: 500),
      delay: delay ?? Duration.zero,
  ...
  /// Scale out animation
  Widget scaleOut({Duration? duration, Duration? delay, Curve? curve, double? from, double? to, VoidCallback? onComplete}) => VooScaleAnimation(
    config: VooAnimationConfig(
      duration: duration ?? const Duration(milliseconds: 500),
      delay: delay ?? Duration.zero,
  ...
  /// Rotate animation
  Widget rotate({Duration? duration, Duration? delay, Curve? curve, double? from, double? to, bool repeat = false, VoidCallback? onComplete}) =>
  ...
  /// Bounce animation
  Widget bounce({Duration? duration, Duration? delay, double? height, int? bounces, bool repeat = false, VoidCallback? onComplete}) => VooBounceAnimation(
    config: VooAnimationConfig(duration: duration ?? const Duration(milliseconds: 1000), delay: delay ?? Duration.zero, repeat: repeat, onComplete: onComplete),
  ...
  /// Shake animation
  Widget shake({Duration? duration, Duration? delay, double? intensity, int? shakes, VoidCallback? onComplete}) => VooShakeAnimation(
    config: VooAnimationConfig(duration: duration ?? const Duration(milliseconds: 500), delay: delay ?? Duration.zero, onComplete: onComplete),
  ...
  Widget flipX({Duration? duration, Duration? delay, Curve? curve, VoidCallback? onComplete}) => VooFlipAnimation(
    config: VooAnimationConfig(
      duration: duration ?? const Duration(milliseconds: 600),
      delay: delay ?? Duration.zero,
  ...
  Widget flipY({Duration? duration, Duration? delay, Curve? curve, VoidCallback? onComplete}) => VooFlipAnimation(
    config: VooAnimationConfig(
      duration: duration ?? const Duration(milliseconds: 600),
      delay: delay ?? Duration.zero,
      curve: curve ?? Curves.easeInOut,
  ...
  Widget parallax({ScrollController? scrollController, double? parallaxFactor, Axis? scrollDirection, bool reversed = false, Alignment? alignment}) =>
  ...
  Widget hoverGrow({double? growScale, Duration? duration, Curve? curve, VoidCallback? onHover, VoidCallback? onExit}) => VooHoverGrowAnimation(
    config: VooAnimationConfig(duration: duration ?? const Duration(milliseconds: 200), curve: curve ?? Curves.easeOutCubic),
  ...
  Widget hoverGlow({
    ...
    config: VooAnimationConfig(duration: duration ?? const Duration(milliseconds: 300), curve: curve ?? Curves.easeInOut),
    glowColor: glowColor ?? Colors.blue,
  ...
  Widget hoverShine({
    ...
    config: VooAnimationConfig(duration: duration ?? const Duration(milliseconds: 600), curve: curve ?? Curves.easeInOut),
  ...
  Widget hoverRotate({double? rotationAngle, Axis? rotationAxis, Duration? duration, Curve? curve, VoidCallback? onHover, VoidCallback? onExit}) =>
  ...
  Widget hoverColor({
    ...
    config: VooAnimationConfig(duration: duration ?? const Duration(milliseconds: 200), curve: curve ?? Curves.easeInOut),
    fromColor: fromColor,
  ...
  Widget hoverBlur({double? blurAmount, bool? blurBackground, Duration? duration, Curve? curve, VoidCallback? onHover, VoidCallback? onExit}) =>
  ...
  Widget withAnimation({required Widget Function(Widget child, VooAnimationConfig config) builder, VooAnimationConfig config = const VooAnimationConfig()}) =>
      builder(this, config);
}
