...
class _VooPulseAnimationState extends State<VooPulseAnimation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(begin: widget.minScale, end: widget.maxScale).animate(CurvedAnimation(parent: _controller, curve: widget.config.curve));

    _opacityAnimation = Tween<double>(begin: widget.pulseOpacity, end: 0.0).animate(CurvedAnimation(parent: _controller, curve: Curves.easeOut));
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
    ...
    builder: (context, child) {
      final pulseWidget = Transform.scale(scale: _scaleAnimation.value, child: widget.child);
          ...
          children: [
            ...
            Transform.scale(
              ...
              child: Opacity(
                ...
                child: DecoratedBox(
                  decoration: BoxDecoration(shape: BoxShape.circle, color: widget.pulseColor ?? Theme.of(context).primaryColor),
                  child: widget.child,
                ),
              ),
            ),
