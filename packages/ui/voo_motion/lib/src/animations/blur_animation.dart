...
class _VooBlurAnimationState extends State<VooBlurAnimation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animation = Tween<double>(begin: widget.fromBlur, end: widget.toBlur).animate(CurvedAnimation(parent: _controller, curve: widget.config.curve));
  ...
  Widget build(BuildContext context) => AnimatedBuilder(
    ...
    builder: (context, child) {
      ...
      return ImageFiltered(
        imageFilter: ImageFilter.blur(sigmaX: sigmaX, sigmaY: sigmaY, tileMode: widget.tileMode),
        child: widget.child,
      );
    },
  );
