...
class _VooScaleAnimationState extends State<VooScaleAnimation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animation = Tween<double>(begin: widget.fromScale, end: widget.toScale).animate(CurvedAnimation(parent: _controller, curve: widget.config.curve));
  ...
  @override
  Widget build(BuildContext context) => ScaleTransition(scale: _animation, alignment: widget.alignment, child: widget.child);
}
