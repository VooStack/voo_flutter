...
class VooAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      title: title != null ? DefaultTextStyle(style: titleTextStyle ?? theme.textTheme.titleLarge ?? const TextStyle(), child: title!) : null,
      ...
      iconTheme: iconTheme ?? IconThemeData(color: theme.colorScheme.onSurface, size: design.iconSizeLg),
      actionsIconTheme: actionsIconTheme ?? IconThemeData(color: theme.colorScheme.onSurfaceVariant, size: design.iconSizeLg),
      primary: primary,
