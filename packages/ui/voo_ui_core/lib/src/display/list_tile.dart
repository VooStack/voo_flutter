...
class _VooListTileState extends State<VooListTile> {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = widget.isSelected
        ? (widget.selectedColor ?? theme.colorScheme.primaryContainer).withValues(alpha: isDark ? 0.3 : 0.2)
        : _isHovered
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: _isHovered ? [BoxShadow(color: theme.colorScheme.primary.withValues(alpha: 0.05), blurRadius: 8, offset: const Offset(0, 2))] : null,
        ),
        child: Material(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        DefaultTextStyle(style: theme.textTheme.bodyMedium ?? const TextStyle(), child: widget.title),
                        if (widget.subtitle != null) ...[
                          const SizedBox(height: 2),
                          DefaultTextStyle(
                            style: (theme.textTheme.bodySmall ?? const TextStyle()).copyWith(color: theme.colorScheme.onSurfaceVariant),
